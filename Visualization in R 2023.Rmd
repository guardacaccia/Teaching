...
As our time is very limited, if you want to go a bit further into the topic of visualization, you can read chapter 8. in the Tilastotieteen käsikirja (p. 147-172, in Finnish). Our exercises are based on the book. There are also useful English materials in the following links: 
